object dmuPrincipal: TdmuPrincipal
  ...
  object qryCelularVenda: TADOQuery
    Connection = dbPrincipal
    CursorType = ctStatic
    CommandTimeout = 0
    Parameters = <
    ...
    SQL.Strings = (
      ...
      '  Distinct'
        ...
        '  CASE WHEN SUBSTRING(Replace(Replace(REPLACE(REPLACE(replace(te' +
        'lecli,'#39'-'#39','#39#39'),'#39'('#39','#39#39' ),'#39')'#39','#39#39'),'#39' '#39','#39#39'),'#39'.'#39','#39#39'),1,1) = 0 THEN'
      
        '     SUBSTRING(Replace(Replace(REPLACE(REPLACE(replace(telecli,'#39 +
        '-'#39','#39#39'),'#39'('#39','#39#39' ),'#39')'#39','#39#39'),'#39' '#39','#39#39'),'#39'.'#39','#39#39'),2,LEN(Replace(Replace(RE' +
        'PLACE(REPLACE(replace(telecli,'#39'-'#39','#39#39'),'#39'('#39','#39#39' ),'#39')'#39','#39#39'),'#39' '#39','#39#39'),'#39 +
        '.'#39','#39#39'))) '
      '  ELSE '
      
        '    Replace(Replace(REPLACE(REPLACE(replace(telecli,'#39'-'#39','#39#39'),'#39'('#39',' +
        #39#39' ),'#39')'#39','#39#39'),'#39' '#39','#39#39'),'#39'.'#39','#39#39') END  as Celular,'
      '  Cidade_v.DDD'
      'from'
      '  pediclicad'
      '    join Cidade_v on Cidade_v.nome=pediclicad.cidadcli  '
      'where'
      '  CodClie=:Cliente   '
      
        '  and Replace(Replace(REPLACE(REPLACE(replace(telecli,'#39'-'#39','#39#39'),'#39'(' +
        #39','#39#39' ),'#39')'#39','#39#39'),'#39' '#39','#39#39'),'#39'.'#39','#39#39') <> '#39#39)
    Left = 488
    Top = 135
    object qryCelularVendaCelular: TStringField
      FieldName = 'Celular'
      Size = 12
    end
    object qryCelularVendaddd: TStringField
      FieldName = 'ddd'
      Size = 3
    end
  end
