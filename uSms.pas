...
type
  TAuxGrid = class(TStringGrid);
    ...
    gbListaPesquisaSatisfação: TGroupBox;
    DBGrid1: TDBGrid;
...
begin
  ...
  begin
    InputQuerySenha('Digite a Senha de liberação de alteração', '', Senha);
...
begin
  ...
  try
    ...
    Application.MessageBox
      ('Aconteceu um erro desconhecido durante a conversão' + 'da tabela para o  Ms-Excel', 'Erro', MB_OK + MB_ICONEXCLAMATION);
  end;
end;
...
begin
  ...
  begin
    ...
    if (LowerCase(copy(Email, 1, pos('@', Email) - 1)) <> 'naotem') and
      (LowerCase(copy(Email, 1, pos('@', Email) - 1)) <> 'nãotem') and
      ...
      (LowerCase(copy(Email, 1, pos('@', Email) - 1)) <> 'nãotememail') and
      (LowerCase(copy(Email, 1, pos('@', Email) - 1)) <> 'nãopossui') and
...
Function FiltroClienteMarketing(Filtro, ParametroFiltro, ParametroFiltro2,
  ...
  Function ConverteFiltroMarketing(Filtro, ParametroFiltro, ParametroFiltro2,
    ParametroFiltro3: String): String;
  begin
    if Filtro = 'Orçamento não aprovado em' then
...
begin
  ...
  begin
    ...
    Procedure VerificandoBaixandoExemplosSms(Arquivo: String);
      ...
      begin
        ...
        begin
          ...
          ShowMessage('Sem Conexão de Internet para baixar o arquivo');
      end;
    ...
    begin
      ...
      begin
        ...
        begin
          ShowMessage('Não existe uma Lista a lista será baixada');
          BaixarArquivoExemplosFtp(Arquivo);
        end
        else
          ShowMessage('Não existe uma lista de Exemplos Disponivel');
      end
      else
      begin
        ...
        begin
          ShowMessage(
            'Existe uma lista nova de exemplos ela será baixada aguarde...');
          BaixarArquivoExemplosFtp(Arquivo);
        end;
      end;
    ...
    begin
      if FileExists('Promoção.txt') then
      begin
        LendoArquivos('Promoção.txt');
    ...
    begin
      ...
      Begin
        ...
        ShowMessage(
          'Não foi possivel baixar a atualização sem conexão com a internet');
    end;
    ...
    begin
      ShowMessage('Este processo demorará alguns segundos aguarde');
    ...
    begin
      ...
      begin
        ...
        if MessageBoxTimer(
          'Existe uma nova versão do simples sms deseja atualizar ?' + #13 +
            '' + #13 + 'Novidades e ajustes da nova Versão' + #13 + '' +
    ...
    begin
      SalvarTela('Promoção.txt', Trim(mmMensagemPromocao.Text),
      ...
      mmMsgMarketing.Lines.Text :=
        'Configuração de Marketing Salvas com Sucesso';
    end;
    ...
    begin
      ...
      mmMsgSatisfacao.Lines.Text :=
        'Configuração de Satisfação Salvas com Sucesso';
    end;
    ...
    begin
      ...
      mmMsgCobranca.Lines.Text := 'Configuração de Cobrança Salvas com Sucesso';
    end;
    ...
    begin
      ...
      mmMsgEntrega.Lines.Text :=
        'Configuração de Aviso de Entrega Salvas com Sucesso';
    end;
    ...
    begin
      ...
      if cbListaFiltrosMarketing.Text = 'Orçamento não aprovado em' then
      begin
        ...
        begin
          ...
          begin
            mmListaEnviados.Lines.Add(
              'Computador Sem internet Verifique sua conexão');
            mmCaixaDeSaida.Lines.Add('Promoção ' + FormatDateTime('dd/mm/yyyy',
          ...
          begin
            if EstaNaListaNegra(Celular) then
              mmListaEnviados.Lines.Add
                ('Sms Maketing não Enviado Lista Negra' + FormatDateTime
          ...
          mmListaEnviados.Lines.Add(
            'Sms não enviado o cliente não possui um celular valido -' +
    ...
    begin
      ...
      begin
        if VerificaProgramacao(lbUltimoEnvioInadimplentesSms.Caption, 'Não',
      ...
      if (btAtivarAvisoVencimento.Caption = 'Desativar') and
        (PermitidaVerificacaoNodia) then
      begin
        if VerificaProgramacao(lbUltimoEnvioSmsAvisoVencimento.Caption, 'Não',
      ...
      if (btAtivarDesativarAniversario.Caption = 'Desativar') and
        (PermitidaVerificacaoNodia) then
      begin
        if VerificaProgramacao(lbUltimoEnvioAniversario.Caption, 'Não',
      ...
      // lbStatusGeral.Caption := 'Verificação Terminada';
    end;
    ...
    begin
      if (pos('[cliente______________________________]',
        ...
        ShowMessage('Já existe a variavel na mensagem')
      else
      ...
      begin
        ...
        begin
          ...
          Begin
            mmListaEnviados.Lines.Add(
              'Computador Sem internet Verifique sua conexão');
            mmCaixaDeSaida.Lines.Add('Cobrança ' + FormatDateTime('dd/mm/yyyy',
                Date) + '-' + FormatDateTime('hh:mm:ss',
                Time) + '-' + Celular + ' ' + Mensagem);
          end
          else
          begin
            if EstaNaListaNegra(Celular) then
              mmListaEnviados.Lines.Add(
                'Sms Cobrança Não Enviado Lista Negra - ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                  Time) + '-' + Celular + ' ' + Mensagem)
            else
            begin
              mmListaEnviados.Lines.Add('Sms Cobrança -  ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                  Time) + '-' + Celular + ' ' + Mensagem);
              // SalvarArquivoHistorico('Sms - Cobrança - '+FormatDateTime('dd/mm/yyyy',Date)+'-'+FormatDatetime('hh:mm:ss',Time)+'-'+Celular+' '+Mensagem);
            end;
          end;
          Contador := Contador + 1;
          ...
          mmListaEnviados.Lines.Add(
            'Sms não enviado o cliente não possui um celular valido -' +
              'Cobrança - ' + copy(dmuPrincipal.qryInadimplentes['NCLIENTE'],
    ...
    procedure TSms.btAtivaDesativaInadimplentesClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ShowMessage('Preencha uma hora para programação');
          Result := true;
        end;
        ...
        if (ckEnviaEmailCobranca.Checked) and (edTItuloEmailCobranca.Text = '')
          then
        begin
          ShowMessage('Preencha um Titulo para o Email de Cobrança');
          Result := true;
        ...
        begin
          ShowMessage('Preencha um Texto para o Email de Cobrança');
          Result := true;
        ...
        if (ckLimitaFiliaisCobranca.Checked) and (edFiliaisCobranca.Text = '')
          then
        begin
          ShowMessage('Preencha as Filiais de Limitação');
          Result := true;
    ...
    begin
      ...
      Begin
        ...
        begin
          ...
          Begin
            ...
            mmMsgCobranca.Lines.Text :=
              'Ativo o Envio de Sms de Cobrança para inicio as ' +
        ...
        begin
          ShowMessage(
            'È Necessário se conectar no banco de dados antes Enviar SMS');
          tsConfiguracao.Show;
        end;
        if not VerificaInternet then
          ShowMessage('Computador Sem internet Verifique sua conexão');
    ...
    procedure TSms.btAtivaDesativaEntregaClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ShowMessage('Preencha uma hora para inicio da programação');
          Result := true;
        end;
        if mkHoraFinalAvisoEntrega.Text = '  :  ' then
        begin
          ShowMessage('Preencha uma hora para final da programação');
          Result := true;
        end;
        ...
        begin
          ShowMessage('Escolha Quando o Sms Será Enviado');
          Result := true;
        end;
        if (rgOpcaoDeEnvio.ItemIndex = 0) and
          ((Trim(edCelularTeste.Text) = '') or
      ...
      begin
        ...
        begin
          ...
          begin
            if EstaNaListaNegra(Celular) then
              mmListaEnviados.Lines.Add(
                'Sms AvisoEntrega Não Enviado Lista Negra - ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                  Time) + '-' + Celular + ' ' + Mensagem)
            else
            begin
    ...
    procedure TSms.btAtivaDesativaPromocaoClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ShowMessage('A opção de filtro está ativa então selecione um filtro');
          Result := true;
    ...
    begin
      { if VerificaPreenchimento  = False then
        ...
        begin
        ShowMessage('È Necessário se conectar no banco de dados antes Enviar SMS');
        tsConfiguracao.Show;
        end;
        if not VerificaInternet then
        Showmessage('Computador Sem internet Verifique sua conexão');
    ...
    begin
      ...
      begin
        ...
        begin
          if EstaNaListaNegra(Celular) then
            Sms.mmListaEnviados.Lines.Add(
              'Sms PesquisaSatisfação Não Enviado Lista Negra - ' +
        ...
        Sms.mmListaEnviados.Lines.Add(
          'Sms não enviado o cliente não possui um celular valido -' +
            'Pesquisa de Satisfação - ' + copy(Nome, 1,
            40) + ' - ' + FormatDateTime('dd/mm/yyyy',
            Date) + '-' + FormatDateTime('hh:mm:ss', Time));
      if VerificaInternet then
      begin
    ...
    begin
      ...
      begin
        Sms.gbListaPesquisaSatisfação.Show;
  ...
  (TMemo(Sms.Components[i]).Lines.LoadFromFile(TMemo(Sms.Components[i])
    ...
    begin
      Sms.Log('Começou a carregar os dados do banco');
    ...
    begin
      ...
      begin
        ...
        try
          ...
          Log('Configurou a Opção de Envio');
          if Linha1 <> '' then
    ...
    begin
      { AssignFile(Arq,'JaEnviados.txt');
        ...
        CloseFile(Arq);
        btZerarNEnviados.Enabled := False;
        mmMsgMarketing.Text := 'Foi zerada a lista de pessoas que já receberam os sms de marketing'; }
    end;
    ...
    begin
      { pnReenviarMsg.Caption := 'Tentando Reenviar Menssagens ,AGuardando Conexão com a internet';
      ...
      begin
        ...
        begin
          ...
          begin
            if EstaNaListaNegra(Celular) then
              mmListaEnviados.Lines.Add(
                'Sms Aniversariante Não Enviado Lista Negra - ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                  Time) + '-' + Celular + ' ' + Mensagem)
            else
            begin
    ...
    begin
      ...
      Begin
        ...
        begin
          ...
          Begin
            ...
            mmMsgAniversariante.Lines.Text :=
              'Ativo o Envio de Sms de parabéns para inicio as ' +
        ...
        begin
          ShowMessage(
            'È Necessário se conectar no banco de dados antes de Enviar SMS');
          tsConfiguracao.Show;
        end;
        if not VerificaInternet then
          ShowMessage('Computador Sem internet Verifique sua conexão');
      ...
      case rgMaxSmsMarketing.ItemIndex of
        0:
          begin
            ...
            mmMsgMarketing.Text :=
              'Os Sms de Marketing serão enviados a todos os clientes';
          end;
        1:
          begin
            edMaxSmsPromocao.Show;
            mmMsgMarketing.Text :=
              'Os Sms de Marketing serão enviados ao numero de Sms definidos';
          end;
      end;
    end;
      ...
      case rgMaxSmsCobranca.ItemIndex of
        0:
          begin
            ...
            mmMsgCobranca.Text :=
              'Os Sms de Cobrança serão enviados a todos os inadimples do filtro';
          end;
        1:
          begin
            edMaxSmsInadimpentes.Show;
            mmMsgCobranca.Text :=
              'Os Sms de Cobrança serão enviados a os numero de Inadimples definidos';
          end;
      end;
    end;
      ...
      case rgMaxSmsEntrega.ItemIndex of
        0:
          begin
            ...
            mmMsgEntrega.Text :=
              'Os Sms de Aviso de Entrega será Enviado a todas as entregas';
          end;
        1:
          begin
            edMaxSmsEntrega.Show;
            mmMsgEntrega.Text :=
              'Os Sms de Aviso de Entrega será limitado o numero de Sms informado';
          end;
      end;
    end;
        ...
        0:
          begin
            ...
            mmMsgAniversariante.Text :=
              'Será enviado Sms de Parabéns a todos os aniversariantes';
          end;
        1:
          begin
            edMaxSmsAniversario.Show;
            mmMsgAniversariante.Text :=
              'Será enviado Sms de parabéns ao numero de Sms definido ';
          end;
      end;
    end;
    ...
    begin
      ...
      mmMsgAniversariante.Lines.Text :=
        'Configuração de Aniversariante Salvas com Sucesso';
    end;
    ...
    procedure TSms.mmExemplosCobrancaPopup(Sender: TObject);
      ...
      Var
        ...
        mItem: TMenuItem;
      begin
        Arquivo := 'ExemplosSmsCobrança.txt';
        if FileExists(Arquivo) then
        begin
          AssignFile(Arq, Arquivo);
          Reset(Arq);
    ...
    begin
      VerificandoBaixandoExemplosSms('ExemplosSmsCobrança.txt');
    ...
    begin
      mmMsgMarketing.Text :=
        'Se precisar clique com o botão direito na mensagem de marketing e veja exemplos de Sms Marketing';
    ...
    begin
      mmMsgCobranca.Text :=
        'Se precisar clique com o botão direito na mensagem de cobrança e veja exemplos de Sms Cobrança';
    ...
    begin
      ...
      mmMsgEntrega.Text :=
        'Se precisar clique com o botão direito na mensagem de Aviso de Entrega e veja exemplos de Sms Aviso de Entrega';
    end;
    ...
    begin
      ...
      mmMsgAniversariante.Text :=
        'Se precisar clique com o botão direito na mensagem de parabéns e veja exemplos de Sms de Parabéns';
    end;
    ...
    begin
      ...
      mmMsgMarketing.Text :=
        'Adicione as datas que serão enviados Sms de Marketing clicando no ' +
        ' ao lado';
    end;
    ...
    begin
      mmMsgMarketing.Text :=
        'Se marcada a opção os Marketing não serão enviados para os mesmos clientes';
    end;
    ...
    begin
      mmMsgCobranca.Text :=
        'Digite uma hora de inicio para o envio dos Sms de Cobranças';
    ...
    begin
      mmMsgCobranca.Text :=
        'Informe se as msgs serão envias para todos o devedore do filtro ou somente para o numero definido';
    end;

    procedure TSms.rgMaxSmsMarketingEnter(Sender: TObject);
    begin
      mmMsgMarketing.Text :=
        'Informe se os Sms Marketing serão enviados para todos os clientes ou para alguns definidos';
    end;

    procedure TSms.edMaxSmsInadimpentesEnter(Sender: TObject);
    begin
      mmMsgCobranca.Text :=
        'Digite um valor para o max de Sms de Cobrança a serem enviados';
    ...
    begin
      ...
      mmMsgCobranca.Text := 'Clique no botão ao lado ' +
    ...
    begin
      dmuPrincipal.qryListaNEnviar.Active := true;
      mmMsgCobranca.Text := 'Clique no botão ao lado ' +
        ' e adicione clientes a lista de pessoas que não devem receber sms de cobrança';
    ...
    procedure TSms.ckAtivaDesativaSatisfacaoClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ...
          ckAtivaDesativaSatisfacao.Checked := False;
          mmMsgSatisfacao.Text :=
            'Preencha uma Mensagem para solicitação de Voto Ruim';
        end;
        ...
        begin
          ...
          ckAtivaDesativaSatisfacao.Checked := False;
          mmMsgSatisfacao.Text :=
            'Preencha um email para ser atualizado dos votos de satisfação';
        end;
        ...
        begin
          ...
          ckAtivaDesativaSatisfacao.Checked := False;
          mmMsgSatisfacao.Text :=
            'Preencha um Celular para ser atualizado dos votos de satisfação';
        end;
      end;
      ...
      begin
        ...
        begin
          ...
          mmMsgSatisfacao.Text := 'Pesquisa de Satisfação Ativo';
        end
        else
        begin
          ...
          mmMsgSatisfacao.Text := 'Pesquisa de Satisfação Desativado';
          tVerificaPesquisaDeSatisfacao.Enabled := False;
    ...
    begin
      mmMsgEntrega.Text :=
        'Selecione a categoria de telefone que receberão o Sms de Aviso de entrega';
    ...
    begin
      mmMsgEntrega.Text :=
        'Informe o Numero de Sms de Aviso de Entrega Serão enviados';
    ...
    begin
      mmMsgEntrega.Text :=
        'Informe se os Sms serão disparados na Emissão da Nota ou Montagem de Carga';
    end;
      ...
      case rgAguardarpor.ItemIndex of
        0:
          begin
            ...
            mmMsgEntrega.Text :=
              'Os Sms de Aviso de Entrega serão enviados no momento da Emissão da Nota Fiscal';
          end;
        1:
          begin
            edFiliais.Hide;
            ...
            mmMsgEntrega.Text :=
              'Os Sms de Aviso de Entrega serão enviados no momento da montagem de carga';
          end;
      end;
    end;
    ...
    begin
      mmMsgAniversariante.Text :=
        'Informe o numero de Sms que serão enviados para Aniversariantes';
    ...
    begin
      mmMsgAniversariante.Text :=
        'Selecione se os Sms serão enviados a todos os Aniversariantes ou a um numero definido';
    end;
    ...
    begin
      mmMsgSatisfacao.Text :=
        'Informe um Celular para receber atualizações da pesquisa de satisfação';
    ...
    begin
      ...
      if (cbListaFiltrosMarketing.Text = 'Orçamento não aprovado em') or
    ...
    begin
      mmMsgMarketing.Text :=
        'Informe um Filtro para os clientes que receberão sms de Marketing';
    end;
          ...
          begin
            ...
            begin
              ...
              mmCaixaDeSaida.Lines.Add
                ('Promoção ' + FormatDateTime('dd/mm/yyyy',
                  Date) + '-' + FormatDateTime('hh:mm:ss',
                  Time) + '-' + Celular + ' ' + Mensagem);
            end
            else
          ...
          begin
            ...
            begin
              if EstaNaListaNegra(EmailaEnviar) then
                mmListaEnviados.Lines.Add(
                  'Email Marketing Não Enviado Lista Negra - ' + FormatDateTime
                    ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                    Time) + '-' + EmailaEnviar + ' ' + Titulo)
              else
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    mmListaEnviados.Lines.Add(
                      'Email não enviado o cliente não possui um Email valido -'
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if EstaNaListaNegra(EmailaEnviar) then
              mmListaEnviados.Lines.Add(
                'Email Maketing Não Enviado Lista Negra - ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
    ...
    begin
      ...
      mmMsgEntrega.Text :=
        'Se precisar clique com o botão direito na mensagem de Aviso de Venda de Email e veja exemplos de Sms Aviso de Venda de Email';
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          if EstaNaListaNegra(Celular) then
            mmListaEnviados.Lines.Add(
              'Sms AvisoVenda Não Enviado Lista Negra - ' + FormatDateTime
                ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                Time) + '-' + Celular + ' ' + Mensagem)
          else
          begin
    ...
    procedure TSms.ckAtivaAvisoOrcamentoSmsClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ...
          mmMsgEntrega.Text :=
            'Preencha uma Mensagem para o Aviso de Orçamento';
        end;
      end;
      ...
      begin
        ...
        begin
          ...
          mmMsgEntrega.Text := 'Aviso de Orçamento Ativo';
          tVerificaVendaOrcamento.Enabled := true;
        end
        else
        begin
          ...
          btInsereClienteOrcamentoSms.Enabled := true;
          // tVerificaVendaOrcamento.Enabled := False;
          mmMsgEntrega.Text := 'Aviso de Orçamento Desativado';
    ...
    begin
      ...
      mmMsgEntrega.Text :=
        'Se precisar clique com o botão direito na mensagem de Aviso de Orçamento e veja exemplos de Sms Aviso de Orçamento';
    end;
        ...
        begin
          ...
          begin
            if EstaNaListaNegra(Email) then
              mmListaEnviados.Lines.Add(
                'AvisoVendaEmail Não Enviado Lista Negra - ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                  Time) + '-' + Email + ' ' + 'EmailAvisoVenda')
            else
            begin
      ...
      begin
        ...
        begin
          ...
          begin
            mmListaEnviados.Lines.Add(
              'Computador Sem internet Verifique sua conexão');
            mmCaixaDeSaida.Lines.Add('AvisoOrçamentoEmail - ' + FormatDateTime
                ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
          ...
          begin
            if EstaNaListaNegra(Email) then
              mmListaEnviados.Lines.Add(
                'AvisoOrçamentoEmail Não Enviado Lista Negra - ' +
                  FormatDateTime('dd/mm/yyyy', Date) + '-' + FormatDateTime
                  ('hh:mm:ss', Time) + '-' + Email + ' ' + 'EmailOrçamento')
            else
            begin
              if (ValidarEMail(Email)) then
              begin
    ...
    begin
      ...
      begin
        ...
        begin
          mmListaEnviados.Lines.Add(
            'Computador Sem internet Verifique sua conexão');
          mmCaixaDeSaida.Lines.Add('Sms AvisoOrçamento ' + FormatDateTime
              ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
              Time) + '-' + Celular + ' ' + Mensagem);
        end
        else
        begin
          if EstaNaListaNegra(Celular) then
            mmListaEnviados.Lines.Add(
              'Sms AvisoOçamento Não Enviado Lista Negra - ' + FormatDateTime
                ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                Time) + '-' + Celular + ' ' + Mensagem)
          else
          begin
            mmListaEnviados.Lines.Add('Sms AvisoOçamento - ' + FormatDateTime
                ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                Time) + '-' + Celular + ' ' + Mensagem);
            // SalvarArquivoHistorico('Sms AvisoOrçamento - '+FormatDateTime('dd/mm/yyyy',Date)+'-'+FormatDatetime('hh:mm:ss',Time)+'-'+Celular+' '+Mensagem);
          end;
        end;
        ...
        mmListaEnviados.Lines.Add(
          'Sms não enviado o cliente não possui um celular valido -' +
            'Aviso de Orçamento - ' + copy(dmuPrincipal.qryOrcamento['Nome'],
            1, 40) + ' - ' + FormatDateTime('dd/mm/yyyy',
            Date) + '-' + FormatDateTime('hh:mm:ss', Time));
      if GetFileSize('EnviaEntrega.txt') > 0 then
      begin
    ...
    begin
      mmMsgEntrega.Text :=
        'Os Sms de Aviso de venda serão entregues no momento que a venda for registrada';
    ...
    begin
      mmMsgEntrega.Text :=
        'Os Sms de Aviso de venda serão entregues no momento que o Orçamento for registrado';
      pnEscondeControleEntrega.Hide;
    end;
    ...
    begin
      ...
      Minimizado := true;
      tIcon.Visible := true;
      tIcon.BalloonHint := 'Clique com o botão direito para Mostrar';
      tIcon.BalloonTitle := 'A Ferramenta Continua ativa na bandeja';
      tIcon.Animate := true;
      tIcon.ShowBalloonHint();
      // Showmessage('O programa contunuará ativo na bandeija');
    end;
    ...
    begin
      ...
      BuscarClientes(EnviarNEnviados, Filtrar, Filtro, ParametroFiltro,
        ParametroFiltro2, ParametroFiltro3);
      if (Filtro = 'Orçamento não aprovado em') or (Filtro = 'Comprou a') or
      ...
      if Limitar = 'Sim' then
        ShowMessage('Numero de Possiveis Sms Hoje em razão do limite - ' +
            IntToStr(NumeroSms) + #13 + 'Não Cosidera Clientes Sem Celular')
      else
        ShowMessage('Numero de Possiveis Sms - ' + IntToStr
            (dmuPrincipal.qryRelClientes.RecordCount) + #13 +
            'Não Cosidera Clientes Sem Celular');
    end;
    ...
    begin
      mmMsgEntrega.Text :=
        'Digite o numero das Centrais de Distribuição separadas por virgula';
    ...
    begin
      ...
      begin
        ...
        mmMsgMarketing.Text :=
          'Preencha as configurações de email antes de ativar o envio';
      end;
      OpcaoDeEnvioEmail;
    ...
    procedure TSms.ckAtivaAvisoOrcamentoEmailClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ...
          ckAtivaAvisoOrcamentoEmail.Checked := False;
          mmMsgEntrega.Text :=
            'Preencha uma Mensagem para o Aviso de Orçamento Email';
        end;
        ...
        begin
          ...
          ckAtivaAvisoOrcamentoEmail.Checked := False;
          mmMsgEntrega.Text :=
            'Preencha um Titulo para os Emails de Aviso de Orçamento';
        end;
      end;
      ...
      begin
        ...
        begin
          ...
          mmMsgEntrega.Text := 'Aviso de Orçamento de Email Ativo';
        end
        else
        begin
          ...
          // mmMsgEntrega.Text := 'Aviso de Orçamento Email Desativado';
        end;
      end;
    ...
    begin
      ...
      mmMsgEntrega.Text :=
        'Informe o Titulo para o Email de Aviso de Orçamento';
    end;
    ...
    begin
      ...
      begin
        ...
        mmMsgEntrega.Text :=
          'Informe uma Msg para o Email de Aviso de Orçamento';
      end;
    end;
    ...
    begin
      mmMsgSatisfacao.Text :=
        'Informe um email para receber atualizações da pesquisa de satisfação';
...
procedure TSms.ituloEmail1Click(Sender: TObject);
    ...
    begin
      ...
      if SelecionaEmailCelularMemo(CelularEmail) then
        ShowMessage('Email ou Celular Já Existe na Lista')
      else
    ...
    begin
      if SelecionaEmailCelularMemo(Inputbox('Pesquisa Lista Negra',
        ...
        ShowMessage('Email ou Celular Não Encontrado');
    ...
    begin
      ...
      lbDesativaAtivaAtualizacaoAutomatica.Caption :=
        'Atualização Automatica de Sms Recebidos Desativada';
    end;
    ...
    begin
      tVerificaRespostasSms.Enabled := true;
      lbDesativaAtivaAtualizacaoAutomatica.Caption :=
        'Atualização Automatica de Sms Recebidos Ativo';
    end;
      ...
      begin
        ...
        begin
          ...
          Begin
            mmListaEnviados.Lines.Add(
              'Computador Sem internet Verifique sua conexão');
            // mmCaixaDeSaida.Lines.Add('Cobrança '+FormatDateTime('dd/mm/yyyy',Date)+'-'+FormatDatetime('hh:mm:ss',Time)+'-'+Celular+' '+Mensagem);
          end
          else
          begin
            if EstaNaListaNegra(Email) then
              mmListaEnviados.Lines.Add(
                'Email Cobrança Não Enviado Lista Negra - ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
                  Time) + '-' + Email + ' ' + Sms.edTItuloEmailCobranca.Text)
            else
            begin
              mmListaEnviados.Lines.Add('Email Cobrança -  ' + FormatDateTime
                  ('dd/mm/yyyy', Date) + '-' + FormatDateTime('hh:mm:ss',
    ...
    begin
      mmMsgSatisfacao.Text :=
        'Se precisar clique com o botão direito na mensagem de Pesquisa de Satisfação e veja exemplos de Sms Pesquisa';
    ...
    begin
      mmMsgAvisoVencimento.Text :=
        'Se precisar clique com o botão direito na mensagem de Aviso de Cobrança e veja exemplos de Sms Aviso de Vencimento';
    ...
    begin
      ...
      mmMsgAvisoVencimento.Lines.Text :=
        'Configuração de Aviso de Vencimento Salvas com Sucesso';
    end;
    ...
    begin
      mmMsgCobranca.Text :=
        'Informe se as msgs serão envias para todos do filtro ou somente para o numero definido';
    end;
      ...
      case rgOpcaodeEnvioAvisoVencimento.ItemIndex of
        0:
          begin
            ...
            mmMsgAvisoVencimento.Text :=
              'Os Sms de Aviso de Vencimento serão enviados a todos do filtro';
          end;
        1:
          begin
            edMaxSmsAvisoVencimento.Show;
            mmMsgAvisoVencimento.Text :=
              'Os Sms de Aviso de Vencimento serão enviados no Numero definido';
          end;
      end;
    end;
      ...
      begin
        ...
        begin
          ...
          begin
            if EstaNaListaNegra(Celular) then
              mmListaEnviados.Lines.Add(
                'Sms Aviso Vencimento Não Enviado Lista Negra - ' +
                  FormatDateTime('dd/mm/yyyy', Date) + '-' + FormatDateTime
                  ('hh:mm:ss', Time) + '-' + Celular + ' ' + Mensagem)
            else
            begin
      ...
      begin
        ...
        begin
          ...
          begin
            if EstaNaListaNegra(Email) then
              mmListaEnviados.Lines.Add(
                'Email de Aviso de Vencimento Não Enviado Lista Negra - ' +
                  FormatDateTime('dd/mm/yyyy', Date) + '-' + FormatDateTime
                  ('hh:mm:ss', Time) + '-' + Email + ' ' +
          ...
          begin
            ...
            if Trim(Sms.mmListaNEnviarCobranca.Text) = '' then
              if SelecionaClienteListaNegra
                ...
                ShowMessage('Cliente já na lista Negra')
              else
    ...
    begin
      ...
      mmMsgMarketing.Text :=
        'Adicione os dias que serão enviados Sms de Marketing clicando no ' +
        ' ao lado';
    end;
    ...
    begin
      ...
      begin
        InputQuerySenha('Digite a senha para permitir alterações',
        ...
        (RecuperarSenha('Alterar') <> '') then
      begin
        InputQuerySenha('Informe a Senha de Alteração', '', Senha);
    ...
    begin
      dmuPrincipal.qryRelTipo.Active := true;
      mmMsgAvisoVencimento.Text := 'Clique no botão ao lado ' +
        ' para adicionar tipos de doccumentos vencidos';
    ...
    begin
      ...
      mmMsgCobranca.Text := 'Informe as Filiais que terão cobrança';
    end;
    ...
    begin
      if VerificaAtualizacao = False then
        ShowMessage('A Ferramenta já esta na sua ultima Versão');
    end;
    ...
    begin
      ...
      mmMsgEntrega.Text :=
        'Se precisar clique com o botão direito na mensagem de Aviso de COnfirmação de Entrega e veja exemplos de Sms Aviso de Confirmação de entrega';
    ...
    begin
      ...
      begin
        ...
        begin
          if EstaNaListaNegra(Celular) then
            mmListaEnviados.Lines.Add(
              'Sms ConfirmacaoEntrega Não Enviado Lista Negra - ' +
                FormatDateTime('dd/mm/yyyy', Date) + '-' + FormatDateTime
                ('hh:mm:ss', Time) + '-' + Celular + ' ' + Mensagem)
          else
          begin
    ...
    procedure TSms.ckAtivaDesativaSmsConfirmacaoEntregaClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ...
          mmMsgEntrega.Text :=
            'Preencha uma Mensagem para o Aviso de Confirmação de Entrega';
        end;
      end;
      ...
      begin
        ...
        begin
          ...
          lbUltimaNotaConfirmada.Caption := dmuPrincipal.qryConfirmacaoEntrega
            ['numnota'];
          mmMsgEntrega.Text := 'Aviso de Confirmação de Entrega Ativo';
          tVerificaConfirmacaoEntrega.Enabled := true;
        end
        else
        begin
          ...
          mmMsgEntrega.Text := 'Aviso de Confirmação de Entrega Desativado';
          tVerificaConfirmacaoEntrega.Enabled := False;
        end;
      end;
